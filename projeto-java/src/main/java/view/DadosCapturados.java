...
public class DadosCapturados extends javax.swing.JFrame {
    ...
    private void insertInInputRegistryInfo() {
        ...
        DiscoUsado1.setText(String.format("%.2f %%", selectResultMachineInfo.get(0).getEspacoTotalDisco1() - selectResultRegistry.get(0).getEspacoLivreDisco1() ));
        DiscoUsado2.setText(String.format("%.2f %%", selectResultMachineInfo.get(0).getEspacoTotalDisco2() - selectResultRegistry.get(0).getEspacoLivreDisco1() ));
